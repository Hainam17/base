...
class AnimatedExtraField extends StatefulWidget {
  AnimatedExtraField({
    Key? key,
    this.interval = const Interval(0.0, 1.0),
    required this.width,
    this.loadingController,
    this.inertiaController,
    this.inertiaDirection, this.child,
  })  : assert((inertiaController == null && inertiaDirection == null) ||
      (inertiaController != null && inertiaDirection != null)),
        super(key: key);
  ...
  @override
  _AnimatedExtraFieldState createState() => _AnimatedExtraFieldState();
}

class _AnimatedExtraFieldState extends State<AnimatedExtraField> {
  late Animation<double> scaleAnimation;
  late Animation<double> sizeAnimation;
  late Animation<double> suffixIconOpacityAnimation;
  ...
  @override
  void didUpdateWidget(AnimatedExtraField oldWidget) {
    super.didUpdateWidget(oldWidget);
